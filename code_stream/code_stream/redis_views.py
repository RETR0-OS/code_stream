...
class PushCellHandler(APIHandler):
    ...
    async def post(self):
        ...
        await redis_client.add_cell(cell_id=cell_id, cell_data=cell_content, timestamp=cell_timestamp)
...
class GetCellHandler(APIHandler):
    ...
    async def get(self):
        ...
        cell_data = await redis_client.get_cell(cell_id=cell_id, cell_timestamp=cell_timestamp)
...
class UpdateCellHandler(APIHandler):
    ...
    async def post(self):
        ...
        success = await redis_client.update_cell(cell_id=cell_id, cell_data=cell_content, timestamp=cell_timestamp)
...
class DeleteCellHandler(APIHandler):
    ...
    async def post(self):
        ...
        success = await redis_client.delete_cell(cell_id=cell_id, cell_timestamp=cell_timestamp)
